...
// listar usuarios
export const listarUsuariosU = async (req, res) => {
	try {
...
// registrar ususario
export const registrarUsuarioU = async (req, res) => {
	try {
		const {
			identificacion,
			nombres,
...
// actualizar usuario
export const actualizarUsuarioU = async (req, res) => {
	try {
...
export const eliminarUsuarioU = async (req, res) => {
	try {
		const { id_usuario } = req.params;
		const [result] = await pool.query(
...
export const buscarUsuarioU = async (req, res) => {
	try {
	  const { id_usuario } = req.params;
